...
This repository contains the source code needed to run the application from a Python script. 
...
Documentation is available at: https://camurria.github.io/GW_Data_Plotter/
